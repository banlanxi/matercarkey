<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:101:"F:\phpStudy_64\phpstudy_pro\WWW\www.jinhong.com\public/../application/admin\view\dashboard\index.html";i:1634854885;s:90:"F:\phpStudy_64\phpstudy_pro\WWW\www.jinhong.com\application\admin\view\layout\default.html";i:1633945806;s:87:"F:\phpStudy_64\phpstudy_pro\WWW\www.jinhong.com\application\admin\view\common\meta.html";i:1633945806;s:89:"F:\phpStudy_64\phpstudy_pro\WWW\www.jinhong.com\application\admin\view\common\script.html";i:1633945806;}*/ ?>
<!DOCTYPE html>
                        ...
                        <div class="panel bg-blue-gradient no-border">
                            <div class="panel-body">
                                <div class="panel-title">
                                   ...
                                   <h5><?php echo __('Today car number count'); ?></h5>
                                </div>
                        ...
                        <div class="panel bg-blue-gradient no-border">
                            <div class="panel-body">
                                <div class="panel-title">
                                    <span class="label label-primary pull-right"><?php echo __('Real time'); ?></span>
                                   <!-- <h5><?php echo __('Category count'); ?></h5> -->
                                   <h5><?php echo __('Today carmen number count'); ?></h5>
                                </div>
                                <div class="panel-content">
                                    <div class="row">
                                        <div class="col-md-12">
                        ...
                        <div class="panel bg-blue-gradient no-border">
                            <div class="panel-body">
                                <div class="panel-title">
                                    <span class="label label-primary pull-right"><?php echo __('Real time'); ?></span>
                                   <!-- <h5><?php echo __('Category count'); ?></h5> -->
                                   <h5><?php echo __('Week car number count'); ?></h5>
                                </div>
                                <div class="panel-content">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h1 class="no-margins"><?php echo 55555; ?></h1>
                                            <div class="font-bold"><i class="fa fa-magic"></i>
                                                <small><?php echo __('Category count tips'); ?></small>
                                            </div>
                                        </div>
                        ...
                        <div class="panel bg-blue-gradient no-border">
                            <div class="panel-body">
                                <div class="panel-title">
                                    <span class="label label-primary pull-right"><?php echo __('Real time'); ?></span>
                                   <!-- <h5><?php echo __('Category count'); ?></h5> -->
                                   <h5><?php echo __('month car number count'); ?></h5>
                                </div>
                                <div class="panel-content">
                                    <div class="row">
                                        <div class="col-md-12">
